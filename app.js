...
const menDom = document.querySelector('.men-center');
...
class UI{ 
    ...
    <article class="man">
        <div class="img-container">
            <img src=${product.image} alt="men product"
            class="man-img">
        ...
        div.classList.add('cart-item');
         ...
         <img src=${item.image} class="cart-img" alt="product">
                    ...
                    <div>
                        ...
                        </i> <p class="item-amount">${item.amount}</p>
...
class Storage{
    ...
    static getCart(){
        return localStorage.getItem('cart') ? JSON.
